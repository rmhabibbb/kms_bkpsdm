        ...
        <div class="row clearfix">
            ...
            <div class="col-xs-12   col-sm-12  col-md-12   col-lg-12 ">
                <ol class="breadcrumb breadcrumb-bg-blue align-left">
                    ...
                    <li> <i class="material-icons">assignment</i> Pengajuan Pengetahuan</li> 
                </ol>
                <div class="card">
                      <div class="header">
                    ...
                    <td class="text-center">
                      <?php if ($row->status == 1) { ?>
                        <a href="<?=base_url('admin/verifikasi/'.$row->id_pengetahuan)?>"  >
                          <button type="button" class="btn  bg-blue"> 
                            <span class="btn-inner--text">Verifikasi</span>
                          </button>
                        </a> 
                      <?php }else{ ?>
                        <a href="<?=base_url('admin/pengajuan/'.$row->id_pengetahuan)?>"  >
                          <button type="button" class="btn  bg-blue"> 
