    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
                ...
                <div class="card">
                    ...
                    <div class="col-lg-12"> 
                        ...
                        <input type="hidden" name="jeniskm" value="<?=$pengetahuan->jenis?>">
                          ...
                          <input required type="text" class="form-control" id="judul" name="judul" value="<?=$pengetahuan->judul?>">  
                        ...
                        <?php if ($pengetahuan->jenis == 'Tacit') { ?>
                          ...
                          <label class="form-control-label" >Pengetahuan</label>  
                           <textarea name="editor1" id="editor1" rows="10" cols="80"><?=$pengetahuan->pengetahuan?></textarea>
                        </div>
                        <?php }else{ ?> 
                          ...
                          <?php  } ?>
                          <label class="form-control-label" >Pengetahuan (.pdf)</label> 
                      ...
                      <div class="col-lg-12">
                        <center> 
                          <a  href="#" data-toggle="modal" data-target="#delete" class="btn bg-red">
                          Hapus
                          </a>
                          <input type="submit" name="simpan" value="Simpan" class="btn bg-primary"><br><br>
                        </center>
                      </div>
                  </div>
            ...
            <div class="card-header border-0">  
              ...
              <center>
                <a href="#" data-toggle="modal" data-target="#kirim" class="btn bg-primary text-white">Kirim Pengajuan Pengetahuan</a>
              </center>
