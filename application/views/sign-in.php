...
<head>
    ...
    <title>Knowledge Management System - Sub Bidang Pengadaan dan Pemberhentian di Badan Kepegawaian dan Pengembangan Sumber Daya Manusia OKU</title>
    <!-- Favicon--> 
    <!-- Google Fonts -->
    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="body">
               ...
               <center> 
                    <a href="<?=base_url('')?>">
                        <h4 style="color:black">Knowledge Management System</h4> <h4 style="color:blue">Sub Bidang Pengadaan dan Pemberhentian di Badan Kepegawaian dan Pengembangan Sumber Daya Manusia OKU</h4>
                     </a>
                </center>
                    <div class="msg">
